...
import kodman.appforpixeltex.mvp.presenter.FactPresenter;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, MvpView {
...
// use snackbar to replace Toast to show Error message
    ...
    @Override
    public void showResult(List<Wallpaper> list) {
        adapter.setWallpapers(list);
